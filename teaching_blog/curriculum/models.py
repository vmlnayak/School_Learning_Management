...
class Subject(models.Model):
    ...
    image = models.ImageField(upload_to=save_subject_image, blank=True,
...
def save_lesson_files(instance, filename):
    ...
    if instance.lesson_id:
        filename = 'lesson_files/{}/{}.{}'.format(instance.lesson_id,
                                                  instance.lesson_id, ext)
        if os.path.exists(filename):
            new_name = str(instance.lesson_id) + str('1')
            filename = 'lesson_images/{}/{}.{}'.format(instance.lesson_id,
                                                       new_name, ext)
    return os.path.join(upload_to, filename)
...
class Lesson(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('curriculum:lesson_list',
